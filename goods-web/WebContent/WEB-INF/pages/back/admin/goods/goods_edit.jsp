				...
				<form action="<%=GOODS_EDIT_URL %>" method="post" class="form-horizontal" id="goodsForm" enctype="multipart/form-data">
					<fieldset>
						...
						<div class="form-group" id="titleDiv">
							...
							<div class="col-md-5">
								<input type="text" id="title" name="title" class="form-control" value="${goods.title }" placeholder="请填写商品名称">
							</div>
						...
						<div class="form-group" id="picDiv">
							...
							<div class="col-md-5">
								<img width="100px" height="100px" src="upload/goods/${goods.photo }"><br>
